...
#define LONG_BUFFER_WIDTH 256
  ...
  // Range Policies
  typedef typename Kokkos::MDRangePolicy< Kokkos::Rank<2, Kokkos::Iterate::Left, Kokkos::Iterate::Left> > MDPolicyType_2D;
  typedef typename Kokkos::MDRangePolicy< Kokkos::Rank<3, Kokkos::Iterate::Left, Kokkos::Iterate::Left> > MDPolicyType_3D;
  typedef typename Kokkos::MDRangePolicy< Kokkos::Rank<4, Kokkos::Iterate::Left, Kokkos::Iterate::Left> > MDPolicyType_4D;
  typedef typename Kokkos::MDRangePolicy< Kokkos::Rank<5, Kokkos::Iterate::Left, Kokkos::Iterate::Left> > MDPolicyType_5D;
#else
  // Default layout
  template <typename T> using View1D = Kokkos::View<T*, execution_space>;
